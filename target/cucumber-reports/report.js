...
formatter.match({
  "location": "CreateCalendarEvents_StepDefs.the_user_is_signed_in_as_a_sale_manager()"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "CreateCalendarEvents_StepDefs.the_user_is_on_the_All_Calendar_Events_page_under_the_Activities_tab()"
});
formatter.result({
  "status": "skipped"
});
...
formatter.match({
  "location": "CreateCalendarEvents_StepDefs.the_user_is_taken_to_the_Create_Calendar_Events_page_after_clicking_the_Create_Calendar_Event_button()"
});
formatter.result({
  "status": "skipped"
});
